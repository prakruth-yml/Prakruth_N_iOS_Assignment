...
////        print("done")
////
////        let tvc = OxfordResultsVC()
////        tvc.meaningFromVC = self.titleField.text
////        self.navigationController?.pushViewController(tvc, animated: true)
//        return true
//    }
    
    @IBAction func buttonDidPush(buttonElement: UIButton){
        
        print("Button Pressed \(buttonElement.currentTitle ?? "nil") \(titleField.text ?? "nil")")
        let secondVC = OxfordResultsVC()
        secondVC.meaningFromVC = self.titleField.text
